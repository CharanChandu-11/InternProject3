...
class TimetableController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.timetable.index', compact('classes', 'selectedClass', 'selectedSection', 'timetable', 'timeSlots', 'days'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.timetable.create', compact('classes', 'timeSlots', 'subjects', 'teachers'));
    }
    ...
    public function edit(Timetable $timetable)
    {
        ...
        return view('admin.timetable.edit', compact('timetable', 'classes', 'timeSlots', 'subjects', 'teachers'));
    }
    ...
    public function editGrid(Classes $class, Section $section)
    {
        ...
        return view('admin.timetable.edit-grid', compact('class', 'section', 'timeSlots', 'days', 'subjects', 'teachers', 'entries'));
    }
