{{-- resources/views/student/syllabi/show.blade.php --}}
...
<div class="animate-fadeInUp">
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-end">
                <a href="{{ route('student.syllabi.index') }}" class="btn btn-sm btn-secondary">
                ...
                <div class="col-md-4">
                    <div class="card bg-light">
                        <div class="card-body">
                            ...
                            <p><strong>Published On:</strong> {{ $syllabus->publish_date ? $syllabus->publish_date->format('d-m-Y') : 'Not published' }}</p>
                        </div>
                    </div>
                </div>
            </div>
