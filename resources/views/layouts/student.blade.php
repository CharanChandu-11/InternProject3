...
<head>
    ...
    <title>@yield('title', 'Student Panel') - Smart School ERP</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            <div class="menu-item {{ request()->routeIs('student.dashboard') ? 'active' : '' }}">
                <a href="{{ route('student.dashboard') }}">
                    <i class="fas fa-tachometer-alt"></i>
                    <span>Dashboard</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('student.profile') ? 'active' : '' }}">
                <a href="{{ route('student.profile') }}">
                    <i class="fas fa-user-circle"></i>
                    <span>My Profile</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('student.syllabi*') ? 'active' : '' }}">
                <a href="{{ route('student.syllabi.index') }}">
                    <i class="fas fa-book-open"></i>
                    <span>Syllabus</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('student.attendance*') ? 'active' : '' }}">
                <a href="{{ route('student.attendance') }}">
                    <i class="fas fa-calendar-check"></i>
                    <span>Attendance</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('student.timetable*') ? 'active' : '' }}">
                <a href="{{ route('student.timetable') }}">
                    <i class="fas fa-clock"></i>
                    <span>Timetable</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('student.calendar*') ? 'active' : '' }}">
                <a href="{{ route('student.calendar.index') }}">
                    <i class="fas fa-calendar-alt"></i>
                    <span>Calendar</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('student.homework*') ? 'active' : '' }}">
                <a href="{{ route('student.homework') }}">
                    <i class="fas fa-book"></i>
                    <span>Homework</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('student.results*') ? 'active' : '' }}">
                <a href="{{ route('student.results') }}">
                    <i class="fas fa-chart-line"></i>
                    <span>Results</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('student.exams*') ? 'active' : '' }}">
                <a href="{{ route('student.exams') }}">
                    <i class="fas fa-file-alt"></i>
                    <span>Exams</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('student.fees*') ? 'active' : '' }}">
                <a href="{{ route('student.fees') }}">
                    <i class="fas fa-rupee-sign"></i>
                    <span>Fees</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('student.library*') ? 'active' : '' }}">
                <a href="{{ route('student.library.books') }}">
                    <i class="fas fa-book-open"></i>
                    <span>Library</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('student.transport*') ? 'active' : '' }}">
                <a href="{{ route('student.transport') }}">
                    <i class="fas fa-bus"></i>
                    <span>Transport</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('student.hostel*') ? 'active' : '' }}">
                <a href="{{ route('student.hostel') }}">
