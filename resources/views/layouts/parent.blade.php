...
<head>
    ...
    <title>@yield('title', 'Parent Panel') - Smart School ERP</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            <div class="menu-item {{ request()->routeIs('parent.dashboard') ? 'active' : '' }}">
                <a href="{{ route('parent.dashboard') }}">
                    <i class="fas fa-tachometer-alt"></i>
                    <span>Dashboard</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('parent.children*') ? 'active' : '' }}">
                <a href="{{ route('parent.children') }}">
                    <i class="fas fa-child"></i>
                    <span>My Children</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('parent.leave-requests*') ? 'active' : '' }}">
                <a href="{{ route('parent.leave-requests.index') }}">
                    <i class="fas fa-umbrella-beach"></i>
                    <span>Leave Requests</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('parent.teachers') ? 'active' : '' }}">
                <a href="{{ route('parent.teachers') }}">
                    <i class="fas fa-chalkboard-user"></i>
                    <span>Teachers</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('parent.messages*') ? 'active' : '' }}">
                <a href="{{ route('parent.messages') }}">
                    <i class="fas fa-envelope"></i>
                    <span>Messages</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('parent.payments.history') ? 'active' : '' }}">
                <a href="{{ route('parent.payments.history') }}">
                    <i class="fas fa-history"></i>
                    <span>Payment History</span>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('parent.notifications') ? 'active' : '' }}">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end p-0" style="width: 320px;">
                        ...
                        <div class="p-2 text-center border-top">
                            <a href="{{ route('parent.notifications') }}" class="text-decoration-none small">View all</a>
                        </div>
                    </div>
                </div>
