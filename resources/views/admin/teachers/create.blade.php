...
<div class="animate-fadeInUp">
    <div class="card">
        <div class="card-header">
            <i class="fas fa-chalkboard-user me-2"></i> Add New Teacher
        </div>
        <div class="card-body">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="professional" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="designation" class="form-control">
                                    ...
                                    @foreach($designations as $desig)
                                        <option value="{{ $desig }}" {{ old('designation') == $desig ? 'selected' : '' }}>{{ $desig }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="employment_type" class="form-control">
                                    ...
                                    @foreach($employmentTypes as $key => $type)
                                        <option value="{{ $key }}" {{ old('employment_type') == $key ? 'selected' : '' }}>{{ $type }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Joining Date</label>
                                <input type="date" name="joining_date" class="form-control" value="{{ old('joining_date', now()->format('Y-m-d')) }}">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <label>Salary (₹)</label>
                                <input type="number" name="salary" class="form-control" value="{{ old('salary') }}" step="any" min="0">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="account" role="tabpanel">
                        ...
                        <div class="alert alert-info mt-3">
                            <i class="fas fa-info-circle me-2"></i> Username will be auto-generated from the teacher's name.
                        </div>
                    </div>
                </div>
