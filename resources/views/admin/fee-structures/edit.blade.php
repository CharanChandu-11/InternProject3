                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" step="0.01" name="amount" class="form-control @error('amount') is-invalid @enderror" 
                               value="{{ old('amount', $feeStructure->amount) }}" placeholder="Enter amount" required>
                        @error('amount')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="frequency" class="form-select @error('frequency') is-invalid @enderror" required>
                            ...
                            <option value="half_yearly" {{ old('frequency', $feeStructure->frequency) == 'half_yearly' ? 'selected' : '' }}>Half Yearly</option>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="form-check">
                            <input type="checkbox" name="is_optional" class="form-check-input" id="is_optional" value="1" {{ old('is_optional', $feeStructure->is_optional) ? 'checked' : '' }}>
