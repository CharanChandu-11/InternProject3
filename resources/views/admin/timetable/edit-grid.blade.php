...
<div class="animate-fadeInUp">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.timetable.update-grid', [$class, $section]) }}" method="POST">
                @csrf
                ...
                <div class="mt-3">
                    ...
                    <a href="{{ route('admin.timetable.index', ['class_id' => $class->id, 'section_id' => $section->id]) }}" class="btn btn-secondary">
                        <i class="fas fa-times me-1"></i> Cancel
                    </a>
                    {{-- <a href="{{ route('admin.timetable.export', [$class, $section]) }}" class="btn btn-info float-end">
